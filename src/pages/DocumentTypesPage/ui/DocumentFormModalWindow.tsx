...
import { attributesStore } from '@/entities/attribute/model/attributesStore';
...
const DocumentFormModalWindow = observer(
  ({ documentType, isOpen, handleClose }: DocumentFormModalWindowProps): ReactElement => {
    ...
    const validationSchema = Yup.object(
      Object.fromEntries(
        attributes.map((attribute) => {
          return [
            attribute.name,
            Yup.string().test(`${attribute.name}-validation`, 'Поле обязательно для заполнения', (value) => {
